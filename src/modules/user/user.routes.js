...
import { recoveryEmailValidation, resetPasswordValidation, signInValidation, signUpValidation, updatePasswordValidation, updateValidation } from "./user.validation.js";
...
import { checkStatus } from "../../middleware/checkStatus.middleware.js";
...
userRouter.post('/forgotPassword', checkValidUser, forgotPassword)
